\chapter*{Example chapter}
{
    ...
    \section{Acronym Package}
    In case you want to use the Acronym package for your abreviations make sure the correct line in included in the thesis.tex file.
