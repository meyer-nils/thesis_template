\chapter*{Example chapter}
{
    ...
    \begin{enumerate}
    	...
    	\item The command \verb!\textcite{key}! adds the author name, such as in this example: \emph{\textcite{Einstein1905} wrote an important paper}. One author or two authors should be explicitly named, more authors are denoted \emph{Einstein et al.} in the text. The command \verb!\textcite{key}! takes care of this automatically.
    \end{enumerate}
...
\section*{Acronyms}
    For using an acronym in you text, use the command \verb|\ac{}| in the brackets write the acronym you want to use. When you use this command for the first time, it will automatically write out the acronym and explanation like this: \ac{CMC}. If you use it afterwards it will only display the abreviation: \ac{CMC}.
    In this way you don't have to check where you used an abreviation the first time, you can always use the command and it will be explained automatically. Additionally in the pdf it will also Link to the acronym chapter every time you use it.
